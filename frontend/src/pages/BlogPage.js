...
export default function BlogPage() {
  ...
  // SEO: Set page meta on mount
  useEffect(() => {
    document.title = "Blog | AI Companion Insights & Tips";
    ...
    setMeta('description', 'Explore our blog for the latest insights on AI companions, virtual relationships, and digital connection tips.');
    setMeta('keywords', 'AI companion, virtual girlfriend, AI chat, digital relationship, AI blog');
    setMeta('og:title', 'Blog | AI Companion Insights', true);
    setMeta('og:description', 'Discover tips, guides, and insights about AI companions and virtual relationships.', true);
